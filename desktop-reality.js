(() => {
  ...
  const welcome = makeWindow({id:'welcome',title:'Disk D:\\DJSG\\README.TXT',className:'dr-welcome',x:145,y:30,html:`<div class="dr-brandline dr-brandline-wordmark"><img src="/assets/dj-sir-gay-wordmark-rainbow.webp" alt="DJ Sir Gay — Stay Fucking Strong logo"><a class="dr-domain" href="https://djsirgay.com">DJSIRGAY.COM</a></div><p>Mashups, narrative DJ sets and pop memories rebuilt by a queer Eastern European artist in exile. This computer contains music, questionable files and a booking button with no sense of proportion.</p><div class="dr-quick"><button class="dr-btn primary" data-open-winamp>▶ Play music</button><button class="dr-btn" data-open-paint>🎨 Paint me gay</button><button class="dr-btn" data-open-stay>▰ Open LED</button><button class="dr-btn" data-open-projects>Disk D:\\PROJECTS</button><button class="dr-btn" data-open-browser>Public Record</button><button class="dr-btn" data-open-presskit>Press kit</button></div>`});
